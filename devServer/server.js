...
/******/ 	var hotCurrentHash = "15fdfbbf58d5720576a3"; // eslint-disable-line no-unused-vars
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar host = exports.host = 'www.piscium.site';\n//export const host = 'localhost'\nvar webPort = exports.webPort = 80;\nvar apiPort = exports.apiPort = 3000;\nvar site = exports.site = 'llk/api';\nvar apiHost = exports.apiHost = 'http://' + host + ':' + webPort + '/' + site;\n\n//# sourceURL=webpack:///./src/server/config.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _constants = __webpack_require__(/*! ./constants */ \"./src/server/constants.js\");\n\nvar _db = __webpack_require__(/*! ./db */ \"./src/server/db.js\");\n\nvar _util = __webpack_require__(/*! ./util */ \"./src/server/util.js\");\n\nvar _email = __webpack_require__(/*! ./email */ \"./src/server/email.js\");\n\nvar _templates = __webpack_require__(/*! ./templates */ \"./src/server/templates.js\");\n\nvar _templates2 = _interopRequireDefault(_templates);\n\nvar _config = __webpack_require__(/*! ./config */ \"./src/server/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar path = __webpack_require__(/*! path */ \"path\");\nvar fs = __webpack_require__(/*! fs */ \"fs\");\nvar express = __webpack_require__(/*! express */ \"express\");\nvar app = express();\nvar bodyParser = __webpack_require__(/*! body-parser */ \"body-parser\");\nvar session = __webpack_require__(/*! express-session */ \"express-session\");\n\napp.use(function (req, res, next) {\n    res.header(\"Access-Control-Allow-Origin\", 'http://' + _config.host + ':' + _config.webPort);\n    res.header(\"Access-Control-Allow-Credentials\", \"true\");\n    res.header(\"Access-Control-Allow-Methods\", \"POST, GET, PUT, DELETE, OPTIONS\");\n    res.header(\"Access-Control-Allow-Headers\", \"Origin, X-Requested-With, Content-Type, Accept\");\n    res.header('Content-Type', 'text/plain');\n    next();\n});\n\napp.use(session({\n    secret: 'keyboard cat',\n    resave: false,\n    saveUninitialized: true,\n    expires: new Date(Date.now() + 20 * 86400 * 1000)\n}));\n\napp.use(bodyParser.urlencoded({ extended: false }));\napp.use(bodyParser.json());\n\n// const site = 'llk/api'\n// const apiHost = `http://localhost:3000/${site}`\n\n\napp.get('/' + _config.site + '/', function (req, res) {\n    console.log('session', req.session);\n    res.send('hello srts');\n});\n\n//user links\napp.get('/' + _config.site + '/links', function (req, res) {\n    console.log('links', req.query);\n    var code = req.query.code;\n    var msg = '';\n    (0, _db.getLink)(code).then(function (_ref) {\n        var email = _ref.email,\n            type = _ref.type,\n            password = _ref.password;\n\n        if (email) {\n            console.log('result.type', type);\n            switch (type) {\n                case 'activate':\n                    msg = 'your account has been activated';\n                    return (0, _db.saveUser)({ email: email }, { active: true });\n                case 'reset':\n                    msg = 'your password has been reset';\n                    return (0, _db.saveUser)({ email: email }, { password: password });\n                default:\n                    return Promise.reject();\n            }\n        }\n    }).then(function () {\n        res.header('Content-Type', 'text/html');\n        res.send(_templates2.default.notification.replace('{$content}', '<p>' + msg + '</p>'));\n    }).catch(function (err) {\n        console.log('err', err);\n        res.send(_constants.CODE.ERROR);\n    });\n});\n\n//get course\napp.get('/' + _config.site + '/course', function (req, res) {\n    var email = req.session.uid;\n    //console.log(`server course session`,req.session)\n    var courseId = req.query.courseId;\n\n    (0, _db.getCourse)(courseId, email).then(function (course) {\n        console.log('server course', course);\n        res.send(JSON.stringify(course || {}));\n    });\n});\n\n//get courses\napp.get('/' + _config.site + '/courses', function (req, res) {\n    var email = req.session.uid;\n    console.log('server courses session', req.session);\n\n    (0, _db.getCourses)(email).then(function (courses) {\n        if (courses && courses.length) {\n            res.send(JSON.stringify(courses.map(function (c) {\n                return { name: c.courseName, id: c._id };\n            })));\n        } else {\n            res.send(JSON.stringify([{ name: 'examples', id: 'example' }]));\n        }\n    });\n});\n\napp.put('/' + _config.site + '/addcourse', function (req, res) {\n    var courseName = req.body.courseName;\n    res.send('add cd');\n});\n\napp.post('/' + _config.site + '/saveCourse', function (req, res) {\n    var _req$body = req.body,\n        courseId = _req$body.courseId,\n        courseName = _req$body.courseName,\n        words = _req$body.words;\n\n    var uid = req.session.uid;\n    console.log('server save course', uid, courseId, courseName, words);\n\n    if (!uid) {\n        res.send(_constants.CODE.NOT_LOGIN);\n    } else {\n        (0, _db.saveCourse)(courseId, uid, courseName, words).then(function () {\n            res.send(_constants.CODE.DONE);\n        }).catch(function (err) {\n            console.error(err);\n            res.send(_constants.CODE.ERROR);\n        });\n    }\n});\n\n//login\napp.post('/' + _config.site + '/login', function (req, res) {\n    var _req$body2 = req.body,\n        email = _req$body2.email,\n        password = _req$body2.password;\n    //console.log(`server login`,email, password)\n\n    (0, _db.findUser)(email).then(function (user) {\n        //console.log(`server login`,user)\n        //console.log(`server login password`,password)\n        if (!user) {\n            res.send(_constants.CODE.WRONG_CREDENTIAL);\n            return;\n        }\n\n        if (!user.active) {\n            res.send(_constants.CODE.NOT_ACTIVE);\n            return;\n        }\n\n        if (password.trim() !== user.password.trim()) {\n            console.log('', password.trim(), user.password.trim());\n            res.send(_constants.CODE.WRONG_CREDENTIAL);\n            return;\n        }\n\n        req.session.uid = email;\n        console.log('login session', req.session);\n        res.send(_constants.CODE.DONE);\n    });\n});\n\napp.post('/' + _config.site + '/logout', function (req, res) {\n    req.session.uid = '';\n    res.send(_constants.CODE.DONE);\n});\n\napp.post('/' + _config.site + '/addcourse', function (req, res) {\n    console.log('param', req.body);\n    res.send('add');\n});\n\napp.post('/' + _config.site + '/register', function (req, res) {\n    var _req$body3 = req.body,\n        email = _req$body3.email,\n        password = _req$body3.password;\n\n\n    (0, _db.findUser)(email).then(function (result) {\n        if (result) {\n            if (result.active) {\n                res.send(_constants.CODE.EMAIL_EXISTED);\n            } else {\n                res.send(_constants.CODE.NOT_ACTIVE);\n            }\n            return;\n        }\n\n        (0, _db.addUser)(email, password).then(function () {\n            return (0, _db.addUserLink)(email, 'activate');\n        }).then(function (code) {\n            //send activate link\n            return new Promise(function (resolve, reject) {\n                var html = '<p>Please click below link to activate your account</p><p><a href=\\'' + _config.apiHost + '/links?code=' + code + '\\'>Activate account</a></p>';\n                (0, _email.sendMail)(email, 'Please activate your account', _templates2.default.notification.replace('{$content}', html), function (err, info) {\n                    if (err) {\n                        reject(err);\n                    }\n                    resolve();\n                });\n            });\n        }).then(function () {\n            res.send(_constants.CODE.DONE);\n        }).catch(function (err) {\n            console.log('err', err);\n            res.send(_constants.CODE.ERROR);\n        });\n    });\n});\n\napp.post('/' + _config.site + '/reset', function (req, res) {\n    var _req$body4 = req.body,\n        email = _req$body4.email,\n        password = _req$body4.password;\n\n\n    (0, _db.findUser)(email).then(function (result) {\n        //email not found\n        if (!result) {\n            res.send(_constants.CODE.EMAIL_NOT_FOUND);\n            return;\n        }\n\n        (0, _db.addUserLink)(email, 'reset', { password: password }).then(function (code) {\n            var html = '<p>Please click below link to reset your password</p><p><a href=\\'' + _config.apiHost + '/links?code=' + code + '\\'>Confirm reset</a></p>';\n            (0, _email.sendMail)(email, 'Please confirm reset password', _templates2.default.notification.replace('{$content}', html), function (err, info) {\n                if (err) {\n                    reject(err);\n                }\n                resolve();\n            });\n        }).then(function () {\n            res.send(_constants.CODE.DONE);\n        });\n    });\n});\n\nexports.default = app;\n\n//# sourceURL=webpack:///./src/server/server.js?");

/***/ }),

/***/ "./src/server/templates.js":
/*!*********************************!*\
  !*** ./src/server/templates.js ***!
  \*********************************/
/*! no static exports found */
